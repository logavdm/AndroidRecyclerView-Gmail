...
import com.gowthami.firebase.adapter.MessagesAdapter;
import com.gowthami.firebase.helper.DividerItemDecoration;
import com.gowthami.firebase.model.Message;
import com.gowthami.firebase.network.ApiClient;
import com.gowthami.firebase.network.ApiInterface;
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               // Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                ...
                Intent intent=new Intent(MainActivity.this, Collectingdata.class);
    ...
    private void getInbox() {
        ...
        call.enqueue(new Callback<List<Message>>() {
            ...
            public void onFailure(Call<List<Message>> call, Throwable t) {
                Toast.makeText(getApplicationContext(), "Unable to fetch from Firebase: " + t.getMessage(), Toast.LENGTH_LONG).show();
                swipeRefreshLayout.setRefreshing(false);
            }
        });
    }
